 ...
 * @property {Number} widthEighth optional, default value: `0`
 * @property {Number} heightEighth optional, default value: `0`
...
export const ProductVariant = new SimpleSchema({
  ...
  // Select the variant type to show different variants.
  "variantType": {
    label: "Type",
    type: String,
    optional: true,
  ...
  // A bool to determine if the variant is a "Height & Width" type.
  "isHeightWidth": {
    type: Boolean,
    optional: true,
    defaultValue: false,
  ...
  // A bool to set product bundle variants
  "isProductBundle": {
    type: Boolean,
    optional: true,
    defaultValue: false,
